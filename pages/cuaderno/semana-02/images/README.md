# Capturas de la semana 2

Coloca aquí las siguientes imágenes, respetando mayúsculas y extensiones. No se muestran espacios reservados: cada imagen aparece cuando su archivo carga correctamente. Pulsa una captura para ampliarla.

- `practica-02-pagina-01.png`: Formulario con etiquetas animadas.
- `practica-02-pagina-02.png`: Pestañas y panel de color RGB.
...
- `Lighthouse-antes.png`: Lighthouse · Antes.
- `Lighthouse-prueba-perfecta.png`: Lighthouse · Revisión final.
